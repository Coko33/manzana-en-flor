...
export default function Preguntas() {
    ...
    return(
        <>
        {isOpenConfirm && <h1>pregunta enviada</h1>}
        <div className="encabezado">
            <h1>MANZANA EN FLOR</h1>
            <h3>Escribí tu pregunta</h3>
        </div>
        <div className="preguntas_contPregunta">
        <div id="muyLargo"><p>Máximo de caracteres alcanzado</p></div>
        <form id="formulario">
            <label htmlFor="nombre">Nombre:</label>
            <input maxLength="20" placeholder="tu nombre" className="preguntas_inputNombre" type="text" name="nombre" onChange={changeHandler}></input>
            <label htmlFor="pregunta">Pregunta:</label>
            <textarea maxLength="121" placeholder="tu pregunta" rows="4" className="preguntas_inputPregunta" type="text" name="pregunta" onChange={changeHandler}></textarea>
            <div className="preguntas_contBoton">
            <button className="preguntas_boton" onClick={(e)=>agregarPregunta(e)}>Agregar</button>
            </div>
        </form>
        </div>
